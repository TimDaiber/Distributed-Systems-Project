...
public class ServiceHandler extends HttpServlet {
	...
	// private BlockingQueue<Callable> queue = new
	// LinkedBlockingQueue<Callable>();
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		out.print("<input name=\"cmbAlgorithm\" type=\"hidden\" value=\""
				+ algorithm + "\">");
		out.print("<input name=\"txtS\" type=\"hidden\" value=\"" + s + "\">");
		out.print("<input name=\"txtT\" type=\"hidden\" value=\"" + t + "\">");
		out.print("<input name=\"frmTaskNumber\" type=\"hidden\" value=\""
				+ taskNumber + "\">");
		out.print("</form>");
		out.print("</body>");
		out.print("</html>");
